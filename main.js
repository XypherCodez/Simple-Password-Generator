...
rl.question("How long should the password be?", function(passLength) {
    ...
    const credits = "Thank you for using my generato, I hope that you use this password to secure your accounts, and I wish that you star and fork the repository https://github.com/XypherCodez/Simple-Password-Generator"
    console.log(credits)
